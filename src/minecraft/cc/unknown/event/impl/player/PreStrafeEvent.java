...
import cc.unknown.script.api.wrapper.impl.event.impl.player.ScriptPreStrafeEvent;
...
@Getter
@Setter
public final class PreStrafeEvent extends CancellableEvent implements Accessor {
    ...
    public ScriptEvent<? extends Event> getScriptEvent() {
        return new ScriptPreStrafeEvent(this);
    }
}
