...
public enum Themes {
    ...
    AQUA("Aqua", new Color(185, 250, 255), new Color(79, 199, 200), ChatFormatting.AQUA, KeyColors.AQUA),
    BANANA("Banana", new Color(253, 236, 177), new Color(255, 255, 255), YELLOW, KeyColors.YELLOW),
    BLEND("Blend", new Color(71, 148, 253), new Color(71, 253, 160), ChatFormatting.AQUA, KeyColors.AQUA, KeyColors.LIME),
    ...
    DIGITAL_HORIZON("Digital Horizon", new Color(95, 195, 228), new Color(229, 93, 135), ChatFormatting.AQUA, KeyColors.AQUA, KeyColors.RED, KeyColors.PINK),
    EXPRESS("Express", new Color(173, 83, 137), new Color(60, 16, 83), DARK_PURPLE, KeyColors.PURPLE, KeyColors.PINK),
    LIME_WATER("Lime Water", new Color(18, 255, 247), new Color(179, 255, 171), ChatFormatting.AQUA, KeyColors.AQUA, KeyColors.LIME),
    ...
    SNOWY_SKY("Snowy Sky", new Color(1, 171, 179), new Color(234, 234, 234), new Color(18, 232, 232), ChatFormatting.AQUA, KeyColors.AQUA, KeyColors.GRAY),
    ...
    WATER("Water", new Color(12, 232, 199), new Color(12, 163, 232), ChatFormatting.AQUA, KeyColors.AQUA, KeyColors.DARK_BLUE),
    LEGACY("Legacy", new Color(0x70CEFF), new Color(0x70CEFF), ChatFormatting.AQUA, KeyColors.AQUA, KeyColors.DARK_BLUE),
    ...
    SHADOW("Shadow", new Color(97, 131, 255), new Color(206, 212, 255), ChatFormatting.AQUA, KeyColors.AQUA),
    ...
    Themes(String themeName, Color firstColor, Color secondColor, ChatFormatting chatAccentColor, KeyColors... keyColors) {
    ...
    Themes(String themeName, Color firstColor, Color secondColor, Color thirdColor, ChatFormatting chatAccentColor, KeyColors... keyColors) {
        this.themeName = themeName;
    ...
    Themes(String themeName, Function<Vector2d, Color> custom, ChatFormatting chatAccentColor, KeyColors... keyColors) {
        this.themeName = themeName;
        this.custom = custom;
        this.chatAccentColor = chatAccentColor;
        this.keyColors = new ArrayList<>(Arrays.asList(keyColors));
	...
	public Function<Vector2d, Color> getCustom() {
		return custom;
	}

	public ChatFormatting getChatAccentColor() {
