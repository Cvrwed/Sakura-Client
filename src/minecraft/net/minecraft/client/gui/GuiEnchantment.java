        ...
        for (int j = 0; j < 3; ++j) {
            ...
            if (this.isPointInRegion(60, 14 + 19 * j, 108, 17, mouseX, mouseY) && k > 0 && l >= 0) {
                ...
                if (Enchantment.getEnchantmentById(l & 255) != null) {
                    ...
                    list.add(ChatFormatting.WHITE.toString() + ChatFormatting.ITALIC + I18n.format("container.enchant.clue", s));
                }
                ...
                if (!flag) {
                    ...
                    if (this.mc.player.experienceLevel < k) {
                        list.add(ChatFormatting.RED + "Level Requirement: " + this.container.enchantLevels[j]);
                    } else {
                        String s1 = "";
                        ...
                        if (i >= i1) {
                            list.add(ChatFormatting.GRAY + "" + s1);
                        } else {
                            list.add(ChatFormatting.RED + "" + s1);
                        }
