...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient {
	...
	public void renderTooltip(ScaledResolution sr, float partialTicks) {
		if (this.field_175271_i != null) {
			...
			if (f <= 0.0F) {
				...
				this.zLevel = -90.0F;
				float f2 = (float) sr.getScaledHeight() - 22.0F * f;
				SpectatorDetails spectatordetails = this.field_175271_i.func_178646_f();
				this.func_175258_a(sr, f, i, f2, spectatordetails);
				this.zLevel = f1;
			}
		}
	}
	...
	private void func_175266_a(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_,
		...
		if (p_175266_5_ != SpectatorMenu.field_178657_a) {
			...
			if (i > 3 && p_175266_5_.func_178662_A_()) {
				this.field_175268_g.fontRendererObj.drawWithShadow(s,
						(float) (p_175266_2_ + 19 - 2 - this.field_175268_g.fontRendererObj.width(s)),
	...
	public void renderSelectedItem(ScaledResolution p_175263_1_) {
		...
		if (i > 3 && this.field_175271_i != null) {
			...
			if (s != null) {
				int j = (p_175263_1_.getScaledWidth() - this.field_175268_g.fontRendererObj.width(s)) / 2;
