...
public class GuiTextField extends Gui {
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            final int l = this.xPosition + 3 /*this.enableBackgroundDrawing ? this.xPosition + 4 : this.xPosition*/;
            final int i1 = this.yPosition + (this.height - 8) / 2 /*this.enableBackgroundDrawing ? this.yPosition + (this.height - 8) / 2 : this.yPosition*/;
            int j1 = l;
