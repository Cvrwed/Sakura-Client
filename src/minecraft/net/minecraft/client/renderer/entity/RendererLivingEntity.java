...
import cc.unknown.event.impl.render.HurtRenderEvent;
import cc.unknown.event.impl.render.RenderModelEvent;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
        ...
        if (!Reflector.RenderLivingEvent_Pre_Constructor.exists() || !Reflector.postForgeBusEvent(Reflector.RenderLivingEvent_Pre_Constructor, entity, this, Double.valueOf(x), Double.valueOf(y), Double.valueOf(z))) {
            ...
            try {
                ...
                if (this.renderOutlines) {
                    ...
                    Sakura.instance.getEventBus().handle(hurtRenderEvent);
    ...
    protected void renderModel(T entitylivingbaseIn, float x, float y, float z, float entityYaw, float entityPitch, float scaleFactor, float partialTicks)
    {
        ...
        if (flag || flag1) {
            ...
            Sakura.instance.getEventBus().handle(renderModelEvent);
