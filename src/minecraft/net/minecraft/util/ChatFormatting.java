...
public enum ChatFormatting {
    ...
    ChatFormatting(final String formattingName, final char formattingCodeIn, final int colorIndex) {
        this(formattingName, formattingCodeIn, false, colorIndex);
    }

    ChatFormatting(final String formattingName, final char formattingCodeIn, final boolean fancyStylingIn) {
        this(formattingName, formattingCodeIn, fancyStylingIn, -1);
    }

    ChatFormatting(final String formattingName, final char formattingCodeIn, final boolean fancyStylingIn, final int colorIndex) {
