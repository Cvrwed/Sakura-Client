	...
	public void populateChunk(IChunkProvider p_76624_1_, IChunkProvider p_76624_2_, int x, int z) {
		...
		if (flag1 && flag2 && flag5) {
			if (!this.isTerrainPopulated) {
				...
				p_76624_1_.func_177460_a(p_76624_2_, this, x, z);
			}
		}
		...
		if (flag3 && flag2 && flag6) {
			...
			if (!chunk.isTerrainPopulated) {
				...
				p_76624_1_.func_177460_a(p_76624_2_, chunk, x - 1, z);
			}
		}
		...
		if (flag && flag1 && flag7) {
			...
			if (!chunk1.isTerrainPopulated) {
				...
				p_76624_1_.func_177460_a(p_76624_2_, chunk1, x, z - 1);
			}
		}
		...
		if (flag4 && flag && flag3) {
			...
			if (!chunk2.isTerrainPopulated) {
				...
				p_76624_1_.func_177460_a(p_76624_2_, chunk2, x - 1, z - 1);
			}
		}
	}
