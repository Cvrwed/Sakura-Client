    ...
    public void processCommand(final ICommandSender sender, final String[] args) throws CommandException {
        if (args.length < 2) {
            ...
            if (entityplayer == sender) {
                ...
                chatcomponenttranslation.getChatStyle().setColor(ChatFormatting.GRAY).setItalic(Boolean.valueOf(true));
                chatcomponenttranslation1.getChatStyle().setColor(ChatFormatting.GRAY).setItalic(Boolean.valueOf(true));
