...
public class CustomItems {
    ...
    private static void addToList(final CustomItemProperties cp, final List<List<CustomItemProperties>> lists, final int id) {
        while (id >= lists.size()) {
            lists.add(new ArrayList<>());
        }

        List<CustomItemProperties> list = lists.get(id);
